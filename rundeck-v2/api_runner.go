...
func (r ApiDownloadRunnerRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *RunnerAPIService) DownloadRunnerExecute(r ApiDownloadRunnerRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiProjectDownloadRunnerRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *RunnerAPIService) ProjectDownloadRunnerExecute(r ApiProjectDownloadRunnerRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Runner configuration request containing project name and automatic assignment setting
...
Configure runner assignment settings for a project in the Rundeck / Runbook Automation runner management system.
            
            This endpoint allows you to set whether runner assignment should be automatic or manual for a specific project.
            When automatic is true, runners will be automatically assigned to execute jobs in this project based on 
            availability and configuration. When false, runners must be manually assigned to the project.
            
            The request body must include a runnerConfigRequest object with the project name and automatic flag.
            
            Authorization required: Application admin access for the project
...
type ApiStartupOperationRequest struct {
	ctx context.Context
	ApiService *RunnerAPIService
	runnerReplicaStartUp *RunnerReplicaStartUp
}

func (r ApiStartupOperationRequest) RunnerReplicaStartUp(runnerReplicaStartUp RunnerReplicaStartUp) ApiStartupOperationRequest {
	r.runnerReplicaStartUp = &runnerReplicaStartUp
	return r
}
...
func (a *RunnerAPIService) StartupOperationExecute(r ApiStartupOperationRequest) (*StartUpResponse, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.runnerReplicaStartUp
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["rundeckApiToken"]; ok {
