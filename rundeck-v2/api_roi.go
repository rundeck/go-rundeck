...
func (r ApiGetRoiMetricsDataApiRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *ROIAPIService) GetRoiMetricsDataApiExecute(r ApiGetRoiMetricsDataApiRequest) (map[string]interface{}, *http.Response, error) {
	var (
