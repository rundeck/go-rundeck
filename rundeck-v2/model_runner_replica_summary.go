...
type RunnerReplicaSummary struct {
	...
	// Maximum concurrent operations this replica is configured to handle.
...
// GetMaxRunningOperations returns the MaxRunningOperations field value if set, zero value otherwise.
func (o *RunnerReplicaSummary) GetMaxRunningOperations() int32 {
	if o == nil || IsNil(o.MaxRunningOperations) {
		var ret int32
		return ret
	}
	return *o.MaxRunningOperations
}

// GetMaxRunningOperationsOk returns a tuple with the MaxRunningOperations field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RunnerReplicaSummary) GetMaxRunningOperationsOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxRunningOperations) {
		return nil, false
	}
	return o.MaxRunningOperations, true
}
...
// SetMaxRunningOperations gets a reference to the given int32 and assigns it to the MaxRunningOperations field.
func (o *RunnerReplicaSummary) SetMaxRunningOperations(v int32) {
	o.MaxRunningOperations = &v
}

// GetQueuedOperations returns the QueuedOperations field value if set, zero value otherwise.
func (o *RunnerReplicaSummary) GetQueuedOperations() int32 {
	if o == nil || IsNil(o.QueuedOperations) {
		var ret int32
		return ret
	}
	return *o.QueuedOperations
}

// GetQueuedOperationsOk returns a tuple with the QueuedOperations field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RunnerReplicaSummary) GetQueuedOperationsOk() (*int32, bool) {
	if o == nil || IsNil(o.QueuedOperations) {
		return nil, false
	}
	return o.QueuedOperations, true
}
...
// SetQueuedOperations gets a reference to the given int32 and assigns it to the QueuedOperations field.
func (o *RunnerReplicaSummary) SetQueuedOperations(v int32) {
	o.QueuedOperations = &v
}

// GetCompletedOperations returns the CompletedOperations field value if set, zero value otherwise.
func (o *RunnerReplicaSummary) GetCompletedOperations() int32 {
	if o == nil || IsNil(o.CompletedOperations) {
		var ret int32
		return ret
	}
	return *o.CompletedOperations
}

// GetCompletedOperationsOk returns a tuple with the CompletedOperations field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RunnerReplicaSummary) GetCompletedOperationsOk() (*int32, bool) {
	if o == nil || IsNil(o.CompletedOperations) {
		return nil, false
	}
	return o.CompletedOperations, true
}
...
// SetCompletedOperations gets a reference to the given int32 and assigns it to the CompletedOperations field.
func (o *RunnerReplicaSummary) SetCompletedOperations(v int32) {
	o.CompletedOperations = &v
}
...
func (o RunnerReplicaSummary) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaxRunningOperations) {
		toSerialize["maxRunningOperations"] = o.MaxRunningOperations
	}
	if !IsNil(o.QueuedOperations) {
		toSerialize["queuedOperations"] = o.QueuedOperations
	}
	if !IsNil(o.CompletedOperations) {
		toSerialize["completedOperations"] = o.CompletedOperations
	}
