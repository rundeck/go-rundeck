...
// Optional authorization secret. Required if webhook is configured to require authorization.
func (r ApiPostRequest) Authorization(authorization string) ApiPostRequest {
