...
type RouterEvent struct {
	...
	Event map[string]map[string]interface{} `json:"event,omitempty"`
}
...
// SetEvent gets a reference to the given map[string]map[string]interface{} and assigns it to the Event field.
