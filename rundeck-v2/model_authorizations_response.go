...
type AuthorizationsResponse struct {
	AuthorizationContext AuthorizationsResponseAuthorizationContext `json:"authorizationContext"`
	Resource AuthorizationsResponseResource `json:"resource"`
...
func (o *AuthorizationsResponse) GetAuthorizationContext() AuthorizationsResponseAuthorizationContext {
	if o == nil {
		var ret AuthorizationsResponseAuthorizationContext
		return ret
	}
...
func (o *AuthorizationsResponse) GetResource() AuthorizationsResponseResource {
	if o == nil {
		var ret AuthorizationsResponseResource
		return ret
	}
