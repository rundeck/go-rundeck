...
func (r ApiApiExecutionDataExportRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *JobsAPIService) ApiExecutionDataExportExecute(r ApiApiExecutionDataExportRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Since v54: Maximum number of jobs to retrieve. If not specified, all jobs will be returned.
func (r ApiApiJobBrowseRequest) Max(max int32) ApiApiJobBrowseRequest {
	r.max = &max
	return r
}

// Since API v58: Same as GET /project/{project}/jobs/browse. Ignored when the request API version is below 58.
func (r ApiApiJobBrowseRequest) MetaExclude(metaExclude string) ApiApiJobBrowseRequest {
	r.metaExclude = &metaExclude
	return r
}
...
func (a *JobsAPIService) ApiJobBrowseExecute(r ApiApiJobBrowseRequest) (*JobBrowseResponse, *http.Response, error) {
	...
	if r.metaExclude != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "metaExclude", r.metaExclude, "form", "")
	}
...
func (a *JobsAPIService) ApiJobBrowseGetDocsExecute(r ApiApiJobBrowseGetDocsRequest) (*JobBrowseResponse, *http.Response, error) {
	...
	if r.metaExclude == nil {
		return localVarReturnValue, nil, reportError("metaExclude is required and must be specified")
	}
	if r.breakpoint == nil {
		return localVarReturnValue, nil, reportError("breakpoint is required and must be specified")
	}
...
func (a *JobsAPIService) ApiJobExportExecute(r ApiApiJobExportRequest) (map[string]interface{}, *http.Response, error) {
	...
	// to determine the Accept header
	localVarHTTPHeaderAccepts := []string{"application/json", "text/yaml", "application/x-yaml"}
...
func (r ApiApiJobFileUploadRequest) Body(body map[string]interface{}) ApiApiJobFileUploadRequest {
	r.body = &body
	return r
}
...
// Since API v58: Comma-separated metadata names to omit. Ignored when the request API version is below 58. When set, if meta includes \&quot;*\&quot;,  it is expanded to all names from registered JobMetadataComponent beans, then exclusions are applied.
func (r ApiApiJobMetaRequest) MetaExclude(metaExclude string) ApiApiJobMetaRequest {
	r.metaExclude = &metaExclude
	return r
}
...
func (r ApiApiJobRetryRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *JobsAPIService) ApiJobRetryExecute(r ApiApiJobRetryRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiApiJobRunRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *JobsAPIService) ApiJobRunExecute(r ApiApiJobRunRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiApiJobRun1Request) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *JobsAPIService) ApiJobRun1Execute(r ApiApiJobRun1Request) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiApiJobsExportv14Request) Max(max int32) ApiApiJobsExportv14Request {
	r.max = &max
	return r
}

func (r ApiApiJobsExportv14Request) Offset(offset int32) ApiApiJobsExportv14Request {
	r.offset = &offset
	return r
}

func (r ApiApiJobsExportv14Request) SortBy(sortBy string) ApiApiJobsExportv14Request {
	r.sortBy = &sortBy
	return r
}

func (r ApiApiJobsExportv14Request) SortOrder(sortOrder string) ApiApiJobsExportv14Request {
...
func (r ApiApiJobsImportv14Request) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *JobsAPIService) ApiJobsImportv14Execute(r ApiApiJobsImportv14Request) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{"application/x-www-form-urlencoded", "multipart/form-data", "application/json", "application/x-yaml"}
...
func (r ApiApiJobsListv2Request) SortBy(sortBy string) ApiApiJobsListv2Request {
	r.sortBy = &sortBy
	return r
}

func (r ApiApiJobsListv2Request) SortOrder(sortOrder string) ApiApiJobsListv2Request {
	r.sortOrder = &sortOrder
	return r
}
...
*/
func (a *JobsAPIService) Job(ctx context.Context, id string) ApiJobRequest {
	return ApiJobRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return []string
func (a *JobsAPIService) JobExecute(r ApiJobRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "JobsAPIService.Job")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiQueryRequest) InputParamMap(inputParamMap map[string]map[string]interface{}) ApiQueryRequest {
...
*/
func (a *JobsAPIService) Query(ctx context.Context, project string) ApiQueryRequest {
	return ApiQueryRequest{
		ApiService: a,
		ctx: ctx,
		project: project,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *JobsAPIService) QueryExecute(r ApiQueryRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "JobsAPIService.Query")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
