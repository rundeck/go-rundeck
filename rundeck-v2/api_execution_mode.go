...
type ApiApiExecutionModeLaterActiveRequest struct {
	...
	apiExecutionModeLaterPassiveRequest *ApiExecutionModeLaterPassiveRequest
}

// Enable Executions. Specify a &#x60;value&#x60; with a time duration expression. (See request schema for syntax.) 
func (r ApiApiExecutionModeLaterActiveRequest) ApiExecutionModeLaterPassiveRequest(apiExecutionModeLaterPassiveRequest ApiExecutionModeLaterPassiveRequest) ApiApiExecutionModeLaterActiveRequest {
	r.apiExecutionModeLaterPassiveRequest = &apiExecutionModeLaterPassiveRequest
	return r
}
...
func (a *ExecutionModeAPIService) ApiExecutionModeLaterActiveExecute(r ApiApiExecutionModeLaterActiveRequest) (*ModeLaterResponse, *http.Response, error) {
	...
	if r.apiExecutionModeLaterPassiveRequest == nil {
		return localVarReturnValue, nil, reportError("apiExecutionModeLaterPassiveRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.apiExecutionModeLaterPassiveRequest
	if r.ctx != nil {
...
func (r ApiApiExecutionModeLaterPassiveRequest) ApiExecutionModeLaterPassiveRequest(apiExecutionModeLaterPassiveRequest ApiExecutionModeLaterPassiveRequest) ApiApiExecutionModeLaterPassiveRequest {
	r.apiExecutionModeLaterPassiveRequest = &apiExecutionModeLaterPassiveRequest
	return r
}
...
type ApiApiProjectDisableLaterRequest struct {
	...
	ApiService *ExecutionModeAPIService
	project string
	apiProjectDisableLaterRequest *ApiProjectDisableLaterRequest
}
...
func (r ApiApiProjectDisableLaterRequest) ApiProjectDisableLaterRequest(apiProjectDisableLaterRequest ApiProjectDisableLaterRequest) ApiApiProjectDisableLaterRequest {
	r.apiProjectDisableLaterRequest = &apiProjectDisableLaterRequest
	return r
}
...
func (a *ExecutionModeAPIService) ApiProjectDisableLaterExecute(r ApiApiProjectDisableLaterRequest) (*ModeLaterResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.apiProjectDisableLaterRequest == nil {
		return localVarReturnValue, nil, reportError("apiProjectDisableLaterRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.apiProjectDisableLaterRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["rundeckApiToken"]; ok {
...
func (r ApiApiProjectEnableLaterRequest) ApiProjectDisableLaterRequest(apiProjectDisableLaterRequest ApiProjectDisableLaterRequest) ApiApiProjectEnableLaterRequest {
	r.apiProjectDisableLaterRequest = &apiProjectDisableLaterRequest
	return r
}
