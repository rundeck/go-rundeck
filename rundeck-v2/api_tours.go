...
type ApiApiProjectToursListRequest struct {
	ctx context.Context
	ApiService *ToursAPIService
	project string
}

func (r ApiApiProjectToursListRequest) Execute() (*Manifest, *http.Response, error) {
	return r.ApiService.ApiProjectToursListExecute(r)
}

/*
ApiProjectToursList Get Project Tours [Enterprise]
...
Authorization required: `admin` for the Project resource.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param project Project Name
 @return ApiApiProjectToursListRequest
*/
func (a *ToursAPIService) ApiProjectToursList(ctx context.Context, project string) ApiApiProjectToursListRequest {
	return ApiApiProjectToursListRequest{
		ApiService: a,
		ctx: ctx,
		project: project,
...
// Execute executes the request
//  @return Manifest
func (a *ToursAPIService) ApiProjectToursListExecute(r ApiApiProjectToursListRequest) (*Manifest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ToursAPIService.ApiProjectToursList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
