...
// if true, use snapshot-based metrics from SCHEDULED_EXECUTION_STATS table (fast, returns empty metrics (all zeros) if no stats exist). if false or not provided, use execution table query (slow, always returns data). Since: v57
func (r ApiApiExecutionMetricsDocsRequest) UseStats(useStats bool) ApiApiExecutionMetricsDocsRequest {
	r.useStats = &useStats
	return r
}

// if true with useStats&#x3D;true, returns metrics for all jobs in the project (batch mode). Requires project parameter. Returns format: {jobs: {uuid1: metrics, uuid2: metrics, ...}}. RUN-3768 Phase 5. Since: v57
func (r ApiApiExecutionMetricsDocsRequest) GroupByJob(groupByJob bool) ApiApiExecutionMetricsDocsRequest {
	r.groupByJob = &groupByJob
	return r
}
...
func (a *JobExecutionsAPIService) ApiExecutionMetricsDocsExecute(r ApiApiExecutionMetricsDocsRequest) (*MetricsQueryResponse, *http.Response, error) {
	...
	if r.useStats != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "useStats", r.useStats, "form", "")
	}
	if r.groupByJob != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "groupByJob", r.groupByJob, "form", "")
	}
	if r.max != nil {
...
// if true, use snapshot-based metrics from SCHEDULED_EXECUTION_STATS table (fast, returns empty metrics (all zeros) if no stats exist). if false or not provided, use execution table query (slow, always returns data). Since: v57
func (r ApiApiExecutionsQueryv14DocsRequest) UseStats(useStats bool) ApiApiExecutionsQueryv14DocsRequest {
	r.useStats = &useStats
	return r
}

// if true with useStats&#x3D;true, returns metrics for all jobs in the project (batch mode). Requires project parameter. Returns format: {jobs: {uuid1: metrics, uuid2: metrics, ...}}. RUN-3768 Phase 5. Since: v57
func (r ApiApiExecutionsQueryv14DocsRequest) GroupByJob(groupByJob bool) ApiApiExecutionsQueryv14DocsRequest {
	r.groupByJob = &groupByJob
	return r
}

// filter adhoc executions by command title (partial match).
func (r ApiApiExecutionsQueryv14DocsRequest) AdhocStringFilter(adhocStringFilter string) ApiApiExecutionsQueryv14DocsRequest {
	r.adhocStringFilter = &adhocStringFilter
	return r
}

// filter executions by node name or filter expression (partial match). Use &#39;name:nodename&#39; for simple node name search, or a filter expression like &#39;tags:value&#39; for complex filters.
func (r ApiApiExecutionsQueryv14DocsRequest) NodeFilter(nodeFilter string) ApiApiExecutionsQueryv14DocsRequest {
	r.nodeFilter = &nodeFilter
	return r
}

// filter executions by option values (partial match, e.g. &#39;-test 123&#39;).
func (r ApiApiExecutionsQueryv14DocsRequest) OptionFilter(optionFilter string) ApiApiExecutionsQueryv14DocsRequest {
	r.optionFilter = &optionFilter
	return r
}
...
func (a *JobExecutionsAPIService) ApiExecutionsQueryv14DocsExecute(r ApiApiExecutionsQueryv14DocsRequest) (*http.Response, error) {
	...
	if r.adhocStringFilter != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "adhocStringFilter", r.adhocStringFilter, "form", "")
	}
	if r.nodeFilter != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nodeFilter", r.nodeFilter, "form", "")
	}
	if r.optionFilter != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "optionFilter", r.optionFilter, "form", "")
	}
	if r.max != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "max", r.max, "form", "")
	}
