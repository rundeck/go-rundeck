...
type RdJobQueryInput struct {
	...
	InputParamMap map[string]map[string]interface{} `json:"inputParamMap,omitempty"`
...
// SetInputParamMap gets a reference to the given map[string]map[string]interface{} and assigns it to the InputParamMap field.
