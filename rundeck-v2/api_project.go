...
type ApiApiProjectExportAsyncPostDocsRequest struct {
	ctx context.Context
	ApiService *ProjectAPIService
	project string
	executionIds *string
	...
	exportScm *bool
	exportWebhooks *bool
	whkIncludeAuthTokens *bool
	whkRegenUuid *bool
}

// A list (comma-separated) of execution IDs
func (r ApiApiProjectExportAsyncPostDocsRequest) ExecutionIds(executionIds string) ApiApiProjectExportAsyncPostDocsRequest {
	r.executionIds = &executionIds
	return r
}

// Export all project contents (default: true)
func (r ApiApiProjectExportAsyncPostDocsRequest) ExportAll(exportAll bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.exportAll = &exportAll
	return r
}

// Include job definitions
func (r ApiApiProjectExportAsyncPostDocsRequest) ExportJobs(exportJobs bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.exportJobs = &exportJobs
	return r
}

// Include execution history
func (r ApiApiProjectExportAsyncPostDocsRequest) ExportExecutions(exportExecutions bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.exportExecutions = &exportExecutions
	return r
}

// Include project configuration
func (r ApiApiProjectExportAsyncPostDocsRequest) ExportConfigs(exportConfigs bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.exportConfigs = &exportConfigs
	return r
}

// Include readme/motd files
func (r ApiApiProjectExportAsyncPostDocsRequest) ExportReadmes(exportReadmes bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.exportReadmes = &exportReadmes
	return r
}

// true/false, include project ACL Policy files, if authorized
func (r ApiApiProjectExportAsyncPostDocsRequest) ExportAcls(exportAcls bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.exportAcls = &exportAcls
	return r
}

// Include SCM configuration (API v28+)
func (r ApiApiProjectExportAsyncPostDocsRequest) ExportScm(exportScm bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.exportScm = &exportScm
	return r
}

// Include webhooks (API v34+)
func (r ApiApiProjectExportAsyncPostDocsRequest) ExportWebhooks(exportWebhooks bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.exportWebhooks = &exportWebhooks
	return r
}

// Include auth tokens when exporting webhooks (API v34+)
func (r ApiApiProjectExportAsyncPostDocsRequest) WhkIncludeAuthTokens(whkIncludeAuthTokens bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.whkIncludeAuthTokens = &whkIncludeAuthTokens
	return r
}

// Regenerate UUIDs for webhooks on import (API v34+)
func (r ApiApiProjectExportAsyncPostDocsRequest) WhkRegenUuid(whkRegenUuid bool) ApiApiProjectExportAsyncPostDocsRequest {
	r.whkRegenUuid = &whkRegenUuid
	return r
}

func (r ApiApiProjectExportAsyncPostDocsRequest) Execute() (*ProjectExport, *http.Response, error) {
	return r.ApiService.ApiProjectExportAsyncPostDocsExecute(r)
}

/*
ApiProjectExportAsyncPostDocs Export a zip archive of the project asynchronously (POST).

Performs the export to a zip archive of the project asynchronously using POST method.
...
Since: v19
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param project Project Name
 @return ApiApiProjectExportAsyncPostDocsRequest
*/
func (a *ProjectAPIService) ApiProjectExportAsyncPostDocs(ctx context.Context, project string) ApiApiProjectExportAsyncPostDocsRequest {
	return ApiApiProjectExportAsyncPostDocsRequest{
		ApiService: a,
		ctx: ctx,
		project: project,
...
func (a *ProjectAPIService) ApiProjectExportAsyncPostDocsExecute(r ApiApiProjectExportAsyncPostDocsRequest) (*ProjectExport, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ProjectExport
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectAPIService.ApiProjectExportAsyncPostDocs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.exportScm != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exportScm", r.exportScm, "form", "")
	}
	if r.exportWebhooks != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exportWebhooks", r.exportWebhooks, "form", "")
	}
	if r.whkIncludeAuthTokens != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "whkIncludeAuthTokens", r.whkIncludeAuthTokens, "form", "")
	}
	if r.whkRegenUuid != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "whkRegenUuid", r.whkRegenUuid, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiApiProjectExportPostDocsRequest struct {
	ctx context.Context
	ApiService *ProjectAPIService
	project string
	executionIds *string
...
// A list (comma-separated) of execution IDs
func (r ApiApiProjectExportPostDocsRequest) ExecutionIds(executionIds string) ApiApiProjectExportPostDocsRequest {
	r.executionIds = &executionIds
	return r
}

// Export all project contents (default: true)
func (r ApiApiProjectExportPostDocsRequest) ExportAll(exportAll bool) ApiApiProjectExportPostDocsRequest {
	r.exportAll = &exportAll
	return r
}

// Include job definitions
func (r ApiApiProjectExportPostDocsRequest) ExportJobs(exportJobs bool) ApiApiProjectExportPostDocsRequest {
	r.exportJobs = &exportJobs
	return r
}

// Include execution history
func (r ApiApiProjectExportPostDocsRequest) ExportExecutions(exportExecutions bool) ApiApiProjectExportPostDocsRequest {
	r.exportExecutions = &exportExecutions
	return r
}

// Include project configuration
func (r ApiApiProjectExportPostDocsRequest) ExportConfigs(exportConfigs bool) ApiApiProjectExportPostDocsRequest {
	r.exportConfigs = &exportConfigs
	return r
}

// Include readme/motd files
func (r ApiApiProjectExportPostDocsRequest) ExportReadmes(exportReadmes bool) ApiApiProjectExportPostDocsRequest {
	r.exportReadmes = &exportReadmes
	return r
}

// true/false, include project ACL Policy files, if authorized
func (r ApiApiProjectExportPostDocsRequest) ExportAcls(exportAcls bool) ApiApiProjectExportPostDocsRequest {
	r.exportAcls = &exportAcls
	return r
}

// Include SCM configuration (API v28+)
func (r ApiApiProjectExportPostDocsRequest) ExportScm(exportScm bool) ApiApiProjectExportPostDocsRequest {
	r.exportScm = &exportScm
	return r
}

// Include webhooks (API v34+)
func (r ApiApiProjectExportPostDocsRequest) ExportWebhooks(exportWebhooks bool) ApiApiProjectExportPostDocsRequest {
	r.exportWebhooks = &exportWebhooks
	return r
}

// Include auth tokens when exporting webhooks (API v34+)
func (r ApiApiProjectExportPostDocsRequest) WhkIncludeAuthTokens(whkIncludeAuthTokens bool) ApiApiProjectExportPostDocsRequest {
	r.whkIncludeAuthTokens = &whkIncludeAuthTokens
	return r
}

// Regenerate UUIDs for webhooks on import (API v34+)
func (r ApiApiProjectExportPostDocsRequest) WhkRegenUuid(whkRegenUuid bool) ApiApiProjectExportPostDocsRequest {
	r.whkRegenUuid = &whkRegenUuid
	return r
}

func (r ApiApiProjectExportPostDocsRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.ApiProjectExportPostDocsExecute(r)
}

/*
ApiProjectExportPostDocs Export a zip archive of the project (POST).

Performs the export to a zip archive of the project synchronously using POST method. _For large projects, consider using the async export endpoint instead._
...
Requires `export` authorization for the project resource.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param project Project Name
 @return ApiApiProjectExportPostDocsRequest
*/
func (a *ProjectAPIService) ApiProjectExportPostDocs(ctx context.Context, project string) ApiApiProjectExportPostDocsRequest {
	return ApiApiProjectExportPostDocsRequest{
		ApiService: a,
		ctx: ctx,
		project: project,
...
// Execute executes the request
//  @return *os.File
func (a *ProjectAPIService) ApiProjectExportPostDocsExecute(r ApiApiProjectExportPostDocsRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectAPIService.ApiProjectExportPostDocs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiApiProjectImportRequest struct {
	...
	apiProjectImportRequest *ApiProjectImportRequest
}
...
// Enable a component for import. Project archives may contain \&quot;components\&quot; which can be imported, beyond the base set of contents. This includes some data used by Runbook Automation (prev. Rundeck Enterprise) features.  For example, to enable Webhook import, you could use &#x60;importWebhooks&#x60; and &#x60;whkRegenAuthTokens&#x60; params, but those are simply shortcuts for the following parameters:  * &#x60;importComponents.webhooks&#x3D;true&amp;importOpts.webhooks.regenAuthTokens&#x3D;true&#x60;  Import schedules definitions:  * &#x60;importComponents.Schedule%20Definitions&#x3D;true&#x60;
...
func (r ApiApiProjectImportRequest) ApiProjectImportRequest(apiProjectImportRequest ApiProjectImportRequest) ApiApiProjectImportRequest {
	r.apiProjectImportRequest = &apiProjectImportRequest
	return r
}
...
func (a *ProjectAPIService) ApiProjectImportExecute(r ApiApiProjectImportRequest) (map[string]interface{}, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.apiProjectImportRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["rundeckApiToken"]; ok {
