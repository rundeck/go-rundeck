...
type ApiApiStoreLicenseRequest struct {
	...
	licenseAgreement *map[string]interface{}
	body *string
}

// true to agree with the Runbook Automation License
func (r ApiApiStoreLicenseRequest) LicenseAgreement(licenseAgreement map[string]interface{}) ApiApiStoreLicenseRequest {
